...
filename_genmodels = 'models_and_data/figA_simplegen.pkl'
if gen_model == 1:
    filename_genmodels = 'models_and_data/figA_complexgen.pkl'
...
filename = 'res_exp_figA_sg_real_model.resout'
if gen_model == 1:
    filename = 'res_exp_figA_cg_real_model.resout'

num_models = len(models)
num_datasets = int(len(datasets) / num_models)
...
for m in np.arange(num_models):
    ...
    for d in np.arange(m*num_datasets,(m+1)*num_datasets):
        print(m, d)
